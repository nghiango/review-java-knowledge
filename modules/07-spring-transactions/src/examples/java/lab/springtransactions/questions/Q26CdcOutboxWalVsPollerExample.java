...
public final class Q26CdcOutboxWalVsPollerExample {
    ...
    public static class OutboxComparison {
        ...
        // Drawback: Constant polling load on database, table bloat from frequent inserts/deletes,
        // latency delay.
        ...
        // Reads database transaction log (PostgreSQL WAL) directly via logical decoding replication
        // slots.
        // Advantage: Zero polling overhead, sub-second latency, near-zero impact on application
        // database.
        // Drawback: Requires Kafka Connect cluster and PostgreSQL logical replication slot
        // monitoring.
