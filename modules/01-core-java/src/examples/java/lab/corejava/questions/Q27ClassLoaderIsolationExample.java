...
public final class Q27ClassLoaderIsolationExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        URL[] urls =
                new URL[] {
                    Q27ClassLoaderIsolationExample.class
                            .getProtectionDomain()
                            .getCodeSource()
                            .getLocation()
                };
        ...
        try (URLClassLoader customLoader1 = new URLClassLoader(urls, null);
            ...
            Class<?> classFromLoader1 =
                    customLoader1.loadClass(Q27ClassLoaderIsolationExample.class.getName());
            Class<?> classFromLoader2 =
                    customLoader2.loadClass(Q27ClassLoaderIsolationExample.class.getName());

            // Even though the bytecode and class names are identical:
            boolean sameClass =
                    (classFromLoader1
                            == classFromLoader2); // false (different initiating ClassLoaders)
