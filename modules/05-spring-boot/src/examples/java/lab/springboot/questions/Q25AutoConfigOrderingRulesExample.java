...
public final class Q25AutoConfigOrderingRulesExample {
    ...
    // In Spring Boot 3+, @AutoConfiguration replaces @Configuration in
    // META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports.
    // 'after' guarantees UpstreamDataSourceAutoConfiguration executes first, so any beans it
    // registers are visible to @ConditionalOnMissingBean.
