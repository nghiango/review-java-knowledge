...
public final class Q29TomcatWorkerExhaustionScenarioExample {
    ...
    public static void main(String[] args) {
        ...
        // If incoming HTTP requests invoke slow, un-timed downstream services (e.g. 5-second latency),
        // 200 concurrent requests completely saturate all worker threads!
        ThreadPoolExecutor tomcatSimulationPool = new ThreadPoolExecutor(
        ...
        // Mitigation:
        // 1. Configure explicit timeouts on all RestClient/WebClient HTTP calls (connectTimeout, readTimeout)
