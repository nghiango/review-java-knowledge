...
public final class Q26ForwardedHeaderSecurityExample {
    ...
    public static void main(String[] args) {
        ...
        // Reverse proxies and API gateways terminate TLS and forward requests to internal Spring
        // Boot services.
        // ForwardedHeaderFilter intercepts incoming requests to adapt getScheme(), getServerName(),
        // and getServerPort()
