...
public final class Q27MetaspaceBytecodeLeakExample {
    ...
    public static void main(String[] args) {
        // Metaspace stores JVM class metadata, method bytecode representations, constant pools, and annotations.
        ...
        for (int i = 0; i < 5; i++) {
            TaskHandler proxy = (TaskHandler) Proxy.newProxyInstance(
        ...
        // If unbounded bytecode generation occurs across short-lived dynamic classloaders without GC:
