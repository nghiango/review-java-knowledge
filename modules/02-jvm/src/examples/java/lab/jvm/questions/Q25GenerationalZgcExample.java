...
public final class Q25GenerationalZgcExample {
    ...
    public static void main(String[] args) {
        ...
        //    If target object is in an evacuating page, the load barrier relocates or self-heals
        // the reference.
        // 3. Generational separation: Young gen collected frequently with lower pause times (<
        // 1ms),
