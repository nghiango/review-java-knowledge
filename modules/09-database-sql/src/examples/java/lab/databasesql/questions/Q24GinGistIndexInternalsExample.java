...
public final class Q24GinGistIndexInternalsExample {
    ...
    // GIN: Best for JSONB containment (@>), full-text search (tsvector), and arrays where elements are extracted
    // into an inverted index. Fast reads, heavier write amplification.
    // GiST: Lossy tree structure best for geometric data, range types ([1, 10]), and nearest-neighbor (k-NN) queries.
    ...
    public static void main(String[] args) {
        ...
        boolean usesJsonbOps = ginSql.contains("jsonb_path_ops"); // true (compact GIN index for @> queries)
