...
public final class Q29AutovacuumWraparoundScenarioExample {
    ...
    //
    // If long-running transactions (or abandoned replication slots) prevent Autovacuum from
    // freezing XIDs,
    // when XID age reaches 2 billion, PostgreSQL shuts down and enters read-only emergency recovery
    // mode!
