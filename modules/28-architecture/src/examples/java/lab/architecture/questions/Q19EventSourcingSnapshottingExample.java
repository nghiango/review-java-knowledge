...
/**
 * Q19: Event Sourcing Schema Evolution and Snapshotting Strategies. Demonstrates optimizing state
 * rehydration using a point-in-time snapshot.
 */
public class Q19EventSourcingSnapshottingExample {
    ...
    public static void main(String[] args) {
        ...
        List<DeltaEvent> delta =
                List.of(new DeltaEvent(100), new DeltaEvent(-50), new DeltaEvent(200));

        int finalBalance =
                SnapshotRehydrator.rehydrate(
                        snapshot, delta); // 5250 (avoided replaying 1000 events)
