...
public final class Q24ProblemDetailFieldErrorsExample {
    ...
    // Allows attaching structured domain metadata (e.g. invalid-params list, correlation ID, error code)
    // to standard HTTP error responses without breaking RFC compliance.
    public static ProblemDetail buildValidationProblem(List<InvalidParameter> fieldErrors, String correlationId) {
    ...
    public static void main(String[] args) {
        List<InvalidParameter> errors = List.of(
